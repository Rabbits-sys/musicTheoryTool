...
// Data: enharmonic equivalence classes by group sections, in ascending semitone order
// Sections from the prompt: 大字二组, 大字一组, 大字组, 小字组, 小字一组, 小字二组
const SECTION_DATA = [
  { label: '大字二组', lines: [
    'G-2 XF-2 bbA-2',
    '#G-2 bA-2',
...
// Format a token for display according to the rules
...
// Parse user input: tokens separated by whitespace, normalized (trimmed)
...
// Get class index for a token; returns -1 if unknown
